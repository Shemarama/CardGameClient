...
void HeartsScreen::updatePlayerInfo() {
  players = crazyEights.getPlayers();
  // for each player
  for (unsigned int i = 0; i < players.size(); ++i) {
...
CardPanel *HeartsScreen::makeCard(wxPanel *parent, Card &card, bool show,
...
wxString HeartsScreen::findHalfImage(Card &card, bool show) {
  if (!show)
...
wxString HeartsScreen::findFullImage(Card &card, bool show) {
  if (!show)
...
void HeartsScreen::displaySuitChoice() {
...
bool HeartsScreen::onClick(Card card) {
  players = crazyEights.getPlayers();
...
/*
void
HeartsScreen::OnExit(wxMouseEvent& event)
{
  // true forces quit
...
void
HeartsScreen::OnExit(wxCommandEvent& event)
{
  // true forces quit
  std::cout << "exit\n";
  //Close(true);
...
void
HeartsScreen::OnAbout(wxCommandEvent& event)
{
  // pop up window
...
void
HeartsScreen::OnHello(wxCommandEvent& event)
{
