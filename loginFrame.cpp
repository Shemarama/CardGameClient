...
LoginFrame::LoginFrame(const wxString& title, wxFrame* parentFrame)
		: wxFrame(parentFrame, wxID_ANY,title,wxDefaultPosition,wxSize(450,300))
{
   ...
   hSizerForButtons = new wxBoxSizer(wxHORIZONTAL); 
    ...
    userPassTextBox = new wxTextCtrl(this, userPassTextID, " ", wxDefaultPosition, wxDefaultSize, wxTE_PASSWORD);
